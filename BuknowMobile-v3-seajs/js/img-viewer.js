//define(function(require){
	...
	var img_viewer = {
		...
		show_img : function() {
			...
			var html = '<div class="overlay" style="z-index:9300;background:rgba(0, 0, 0, 1);"><div class="picCount"><span class="curPic">1</span>/<span class="totalPic">50</span></div><div class="pic-viewer"><div class="img" id="img'+ img_viewer.whichpic +'"><img src="'+bigimg+'"></div></div><a href="javascript:void(0);" class="hide-img">关闭</a></div>';
		...
		hide_loading : function(id) {
			...
			$("#img"+ id).append($('<div class="load-pic"></div>'));
			img.onload = function() {
				$("#img"+ id +" .load-pic").remove(); 
				//img_viewer.imgScroll = new IScroll(".pic-viewer", { scrollY : true, mouseWheel : true, click : true });
			}
		},
		...
		nextPic : function() {
			...
			$.post(url,{'page':self.page,'ecouponshopid':ecouponshopid},function(data){
				...
				self.$viewer.append('<div class="img" style="left:100%;" id="img'+ self.whichpic +'"><img src="'+data+'"></div>');
